        ...
        if (user) {
          ...
          if (user.uid !== creator_uid) {
            ...
            if (newUser === true) {
              ...
              await database()
                .ref(
                  `code-sessions/${session_id}/users-connected/user-` +
                    this.state.key
                )
                .set({
                  user_id: user.uid,
    ...
    if (!this.state.isCreator) {
      userEditingToggle = (
        <button
          ...
          onClick={null}
        >
          {this.state.readOnly ? "Editing: Disabled" : "Editing: Enabled"}
        </button>
      );
    }
          ...
          extras={
            <div>
              ...
              <span className="header-menu">
                <select
                  className="btn-coding margin-l-10 mode-dropdown"
